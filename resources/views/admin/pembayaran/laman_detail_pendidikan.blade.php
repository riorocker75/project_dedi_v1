...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Laman Penambahan Tabungan Pendidikan</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ url('/dashboard/admin')}}">Home</a></li>
                <li class="breadcrumb-item active">Laman Penambahan Tabungan Pendidikan</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <section class="col-lg-6 connectedSortable">
              <div class="card">
                ...
                <div class="card-header">
                 ...
                 Tambah Nilai Tabungan Pendidikan
                  </h3>
                ...
                <div class="card-body">
                    <form action="{{url('/admin/pembayaran/simpanan-pendidikan/tambah')}}" method="post">
                        @csrf
                     ...
                     @php
                      ...
                      @endphp
                        ...
                        <div class="form-group">
                            ...
                            <input type="number"
                        class="form-control" name="nominal" id="format_rupiah" min="10000" value="{{$dt->angsuran_pend}}" required>
            ...
            <section class="col-lg-6 connectedSortable">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body collapse" id="simpanan">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text"
                                class="form-control" value="{{$ops_lain->jenis_simpanan}}" disabled>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                class="form-control" value="Rp.{{number_format($dt->angsuran_pend)}}" disabled>
                            </div>
                      ...
                      <div class="card-body collapse" id="transfer">
                          ...
                          <table id="data2" class="table table-bordered table-striped">
                              ...
                              <tbody> 
                                ...
                                <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#view_tr_pendidikan{{$bn->id}}"><i class="fa fa-eye"></i> </button>
                                <a href="{{url('/admin/pembayaran/simpanan-pendidikan/transfer/hapus/'.$bn->id)}}" style="padding:0 7px"> <i class="fa fa-trash"></i></a>
                                  
                                  {{-- modal transfer bukti bayar --}}
                                  <div class="modal fade" id="view_tr_pendidikan{{$bn->id}}" >
                                    <div class="modal-dialog modal-dialog-centered" role="dialog">
                                      <div class="modal-content">
                                        ...
                                        <form action="{{url('/admin/pembayaran/simpanan-pendidikan/transfer/act')}}" method="post">
                                          @csrf
                      ...
                      <div class="card-body collapse" id="tarik-dana">
                          <table id="data4" class="table table-bordered table-striped">
                              ...
                              <tbody> 
                                ...
                                <a href="{{url('/admin/penarikan/simpanan-pendidikan/hapus/'.$tdn->id)}}" style="padding:0 7px" onclick="return confirm('Yakin menghapus data ini ?')"> <i class="fa fa-trash"></i></a>
                                  ...
                                  <div class="modal fade" id="view_tarik{{$tdn->id}}" >
                                    <div class="modal-dialog modal-dialog-centered" role="dialog">
                                      <div class="modal-content">
                                        ...
                                        <form action="{{url('/admin/penarikan/simpanan-pendidikan/act')}}" method="post">
                                          @csrf
                                        <div class="modal-body">
                                          <div class="form-group">
              ...
              {{-- riwayat Transaksi Simpanan Pendidikan --}}
              <section class="col-lg-12 connectedSortable">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">
                  ...
                  <div class="card-body">
                      ...
                      @if(count($data) > 0)
                      <form action="{{url('/cetak/transaksi/simpanan/pendidikan/filter/'.$dt->no_rekening)}}" method="post" target="__blank">
                        @csrf
                        <div class="row">
    ...
    <div class="modal fade" id="tutup-umum" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form action="{{url('/admin/pembayaran/simpanan-pendidikan/tutup-rekening')}}" method="post">
            @csrf
          <div class="modal-body">
         
            <div class="form-group">
              <label for="">Total Tabungan Pendidikan</label>
              <input type="text"
              class="form-control" value="Rp.{{number_format($dt->total_angsur)}}" disabled>
          </div>
