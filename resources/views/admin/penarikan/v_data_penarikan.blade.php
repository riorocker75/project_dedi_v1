...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Data Penarikan Dana</h1>
            </div>
            <div class="col-sm-6">
                           ...
                           @foreach ($data as $dt)
                             ...
                             <tr>
                                <td>{{$dt->kode_transaksi}}
                                    <br>
                                    <small class="tgl-text">{{format_tanggal(date('Y-m-d', strtotime($dt->tgl_aju)))}}</small>
                                </td>
                              ...
                              <td><label class="badge badge-warning">menunggu konfirmasi</label></td>
                                ...
                                <td>
                                    {{ link_tarik_dana($dt->jenis, $dt->no_rekening)}}
                                </td>
                             </tr>
                             @endforeach
