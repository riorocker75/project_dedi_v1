                      ...
                      <table id="data1" class="table table-bordered table-striped">
                        ...
                        <tbody> 
                          @foreach ($data_aju as $cp)
                            ...
                            <td><label class="badge badge-success">{{status_pinjaman($cp->pinjaman_status)}}</label></td>
                            <td>
                            <a href="{{url('/admin/review-pinjaman/'.$cp->id.'')}}"> <i class="fa fa-eye" aria-hidden="true" ></i></a>
                            </td>
