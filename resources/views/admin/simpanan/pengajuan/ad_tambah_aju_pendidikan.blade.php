...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Pemohon Simpanan Pendidikan</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ url('/dashboard/admin')}}">Home</a></li>
                <li class="breadcrumb-item active">Tambah Pemohon Simpanan Pendidikan</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <section class="col-lg-6 connectedSortable">
              <div class="card">
                ...
                <div class="card-body">
                    <form action="{{url('/admin/pemohon/simpanan-pendidikan/tambah/act')}}" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            @endphp
                            <select class="selectpicker form-control form-control-user " name="nominal" data-live-search="true" id="pendidikan" required>
                        ...
                        <button class="btn btn-primary float-right" type="submit" style="display:none" id="tampil_pendidikan"> <i class="fas fa-save    "></i> Setujui Simpanan</button>
                    </form>   
                </div>
              </div>
            </section>
