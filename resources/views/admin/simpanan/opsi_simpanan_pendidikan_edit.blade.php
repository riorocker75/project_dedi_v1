...
<div class="content-header">
 ...
 <section class="content">
    <div class="container-fluid">
      ...
      <div class="row">
        <section class="col-lg-4 col-md-12 col-12 connectedSortable">
          <div class="card">
            ...
            <form action="{{url('/admin/pengaturan/simpanan-pendidikan/update/'.$da->id)}}" method="post">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number"
                      class="form-control" name="periode" min="1" value="{{$da->jangka_simpanan}}" required>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number"
                      class="form-control" name="bunga" step=".01" value="{{$da->bunga}}" required>
        ...
        <section class="col-lg-8 col-md-12 col-12 connectedSortable">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">
              ...
              <div class="card-body">
                <table id="data1" class="table table-bordered table-striped">
                  <thead>
                      <tr>
                        <th width="25%">Nama Jenis Simpanan</th>
