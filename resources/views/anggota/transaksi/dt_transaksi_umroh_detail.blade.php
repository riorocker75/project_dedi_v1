...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Simpanan Umroh</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ url('/dashboard/anggota')}}">Home</a></li>
                <li class="breadcrumb-item active">Simpanan Umroh</li>
              </ol>
            </div>
          </div>
        </div>
            ...
            <section class="col-lg-12 connectedSortable">
              <div class="card">
                ...
                <div class="card-body">
                   ...
                   @if(count($data) > 0)
                   <form action="{{url('/cetak/transaksi/simpanan/umroh/filter/'.$ds->no_rekening)}}" method="post" target="__blank">
                     @csrf
                     <div class="row">
