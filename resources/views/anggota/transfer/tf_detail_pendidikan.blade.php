...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Bayar Angsuran Pendidikan Secara Transfer</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ url('/dashboard/anggota')}}">Home</a></li>
                <li class="breadcrumb-item active">Bayar Angsuran Pendidikan Secara Transfer</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <section class="col-lg-6 connectedSortable">
              <div class="card">
                ...
                @endphp
                <div class="card-body">
                  <form action="{{url('/anggota/simpanan-pendidikan/transfer/act/'.$dt->no_rekening)}}" enctype="multipart/form-data" method="post" >
                  @csrf
