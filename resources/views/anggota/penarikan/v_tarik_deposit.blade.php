     ...
     <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
              ...
              @php
                  $op= App\Model\Simpanan\OpsiSimpananBerjangka::where('id',$dt->opsi_deposit_id)->first();
            ...
            <section class="col-lg-6 connectedSortable">
              <div class="card">
                <div class="card-header">
                  ...
                  Tarik Dana <b>{{$dt->rekening_deposit}}</b>
                  </h3>
                ...
                <div class="card-body">
                <form action="{{url('/anggota/simpanan-deposit/tarik/act')}}" method="post" >
                    @csrf
                    <div class="form-group">
                      <label for="">Nominal Tarik</label>
                      <input type="number"
                    class="form-control" name="nominal" max="{{$dt->total_nisbah}}" min="5000" id="format_rupiah" required>
                        ...
                        <tbody> 
                           @foreach ($data_narik as $dn)
                             ...
                             <tr>
                                ...
                                <a href="{{url('/anggota/simpanan-deposit/tarik/delete/'.$dn->id)}}" style="padding:0 7px" onclick="return confirm('Anda yakin membatalkan / hapus penarikan ini ?')"> <i class="fa fa-trash"></i></a>
                                </td>
                             </tr>
                             @endforeach
