          ...
          <div class="row">
            ...
            <section class="col-lg-6 connectedSortable">
              <div class="card">
                ...
                <div class="card-body">
                <form action="{{url('/anggota/simpanan-umroh/tarik/act')}}" method="post" >
                    @csrf
                        ...
                        <tbody> 
                           @foreach ($data_narik as $dn)
                             ...
                             <tr>
                                ...
                                <a href="{{url('/anggota/simpanan-umroh/tarik/delete/'.$dn->id)}}" style="padding:0 7px" onclick="return confirm('Anda yakin membatalkan / hapus penarikan ini ?')"> <i class="fa fa-trash"></i></a>
                                </td>
                             </tr>
                             @endforeach
