     ...
     <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
              ...
              @php
                  $op= App\Model\Simpanan\OpsiSimpanan::where('id',1)->first();
            ...
            <section class="col-lg-6 connectedSortable">
              <div class="card">
                ...
                <div class="card-body">
                <form action="{{url('/anggota/simpanan-umum/tarik/act')}}" method="post" >
                    @csrf
                    <div class="form-group">
                      <label for="">Nominal Tarik</label>
                      <input type="number"
                    class="form-control" name="nominal" max="{{$dt->total_simpanan}}" min="5000" id="format_rupiah" required>
                        ...
                        <tbody> 
                           @foreach ($data_narik as $dn)
                             ...
                             <tr>
                                ...
                                <a href="{{url('/anggota/simpanan-umum/tarik/delete/'.$dn->id)}}" style="padding:0 7px" onclick="return confirm('Anda yakin membatalkan / hapus penarikan ini ?')"> <i class="fa fa-trash"></i></a>
                                </td>
                             </tr>
                             @endforeach
